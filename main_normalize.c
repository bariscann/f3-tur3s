...
int main()
{
    ...
    char *labels2[]= {"walking","minibus","car","bus","tram","metroK","metroH","marmaray","metrobus","ferry"};
    ...
    strcat(dosyaAdiYazma,min_maxYAZ);
    fWrite1 = fopen(dosyaAdiYazma, "wb");
    
    fwrite(fMin , degerlerMin_MaxBoyut , sizeof(OZELLIK_MIN) , fWrite1 );
    fwrite(fMax , degerlerMin_MaxBoyut , sizeof(OZELLIK_MAX) , fWrite1 );
